...
class NNPred;
class GAUDI_API ReadPodioAlg : public GaudiAlgorithm {
public:
  /**
   ** Constructor(s)
   **/
...
private:
  ...
  DataHandle<edm4hep::SimTrackerHitCollection> r_SimDCHCol{"DCHIonizedEleCollection", Gaudi::DataHandle::Reader, this};
